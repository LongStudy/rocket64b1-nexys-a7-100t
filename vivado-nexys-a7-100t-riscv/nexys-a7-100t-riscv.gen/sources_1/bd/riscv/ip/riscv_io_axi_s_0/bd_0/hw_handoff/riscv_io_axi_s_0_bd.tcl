...
################################################################
# This is a generated script based on design: bd_9a00
#
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC000_ROUTE {0b100011} \
   CONFIG.MSC001_ROUTE {0b100101} \
   CONFIG.MSC002_ROUTE {0b101001} \
   CONFIG.MSC003_ROUTE {0b110001} \
   CONFIG.MSC_ROUTE_WIDTH {6} \
   CONFIG.NUM_MSC {4} \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000000060000000} \
   ...
   CONFIG.SEG001_BASE_ADDR {0x0000000060010000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000060020000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x0000000060030000} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins M00_ACLK] [get_bd_pins M01_ACLK] [get_bd_pins aclk1] [get_bd_pins psr_aclk1/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M02_ACLK] [get_bd_pins M03_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins M01_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M02_ARESETN] [get_bd_pins M03_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M02_AXI:M03_AXI:S00_AXI} \
 ] $aclk
