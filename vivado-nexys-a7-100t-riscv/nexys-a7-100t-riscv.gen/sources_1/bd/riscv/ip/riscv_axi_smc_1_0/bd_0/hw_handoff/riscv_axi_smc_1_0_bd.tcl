...
################################################################
# This is a generated script based on design: bd_fe52
#
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net clk_map_aclk_net [get_bd_pins S00_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk/slowest_sync_clk]
